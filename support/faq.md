---
title: "Veelgestelde vragen over EnerCalculatie"
description: "Antwoorden op veelgestelde vragen over berekeningen, gebruik van EnerCalculatie, foutmeldingen, abonnementen en supportvragen van installateurs en adviseurs."
---
...
Als er geen bouwtechnische tekeningen zijn, selecteert u in EnerCalculatie het bouwjaar van de woning. De software past dan automatisch de _forfaitaire waarden_ toe conform de ISSO-richtlijnen. Dit zijn historisch veilige aannames voor die specifieke bouwperiode.
...
De LLM-technologie achter onze parser zoekt niet naar vaste posities op de pagina, maar begrijpt de _context_ van begrippen zoals 'levering', 'teruglevering', 'dal' en 'normaal'. Hierdoor worden nieuwe leveranciers direct correct geïnterpreteerd.
...
Ja, de AI is meertalig en herkent de energetische context (zoals _consumption_ of _Lieferung_) probleemloos, om deze vervolgens correct te mappen naar het Nederlandse calculatiemodel.
...
De engine berekent de _sweet spot_ door de uur-tot-uur opwekking van de zonnepanelen te leggen over het uur-tot-uur verbruiksprofiel van de klant. Hierdoor zie je exact bij welke batterijcapaciteit (kWh) de hoogste circulariteit en kortste terugverdientijd wordt behaald.
...
### 47. Kan de software een berekening maken voor een klant die al zonnepanelen heeft en _alleen_ een batterij wil toevoegen?
...
Een vast maandbedrag zorgt voor voorspelbare softwarekosten zonder verrassingen achteraf. Hierdoor stimuleer je je adviseurs ook om _elke_ lead door de software te halen, wat de algehele conversie verhoogt.
...
Als Launch Partner behoud je via onze _grandfather clause_ je initiële lage instaptarief voor de rest van de levensduur van je contract. Prijsverhogingen gelden alleen voor nieuwe klanten.
...
Het opzetten van een test-tenant kost letterlijk 10 minuten. Je test de software niet 'naast' je werk, maar _tijdens_ je werk op een live lead. Het levert je vanaf de allereerste upload direct tijdswinst op.
...
Nee, EnerCalculatie draait harmonieus _naast_ of _als add-on op_ je huidige systemen. Je hoeft niks te migreren of stop te zetten; je voegt enkel een krachtige reken- en parsemotor toe aan je bestaande keten.
...
Consumenten beslissen niet sneller, maar de _gunfactor_ en de _attentiewaarde_ zijn het hoogst op het moment dat de klant de aanvraag doet. De installateur die als eerste een professionele, kloppende offerte aanlevert, claimt de poleposition en wint in 60% of de gevallen de deal.
